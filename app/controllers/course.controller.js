...
exports.create = async (req, res) => {
  ...
  try {
    ...
    if (data) {
      return res.status(400).json({ message: "Khóa học đã tồn tại, nhập khóa học khác" });
    }
    else {
...
exports.update = async (req, res) => {
  ...
  const { _id, name, shortDesc, content, categoryID,
    dateStart, dateEnd, tuition, schedule, lecture } = req.body
