...
router.post("/upload", [authJwt.verifyToken, authJwt.isManagePermission], parseUpload(), controller.upload);
router.delete("/:id", [authJwt.verifyToken, authJwt.isManagePermission], controller.delete);
